...
function arrayContiene(array, elemento) {
  ...
  // Tu código:
  for (let i = 0; i < agregarItemAlFinalDelArray.length; i++) {
    if (array[i] == elemento) {
      return true
    }
  } return false;
...
function empiezaConNueve(n) {
  ...
  //Escribe tu código aquí
  var nn = n.toString();
  var PrimerElemento = nn.charAt(0);
  if (PrimerElemento == "9") {
    return true;
  } return false;
}
...
function mesesDelAño(array) {
  ...
  // Tu código:
  let array3= array.filter((palabra) => palabra ==="Enero" || palabra ==="Marzo" || palabra ==="Noviembre");
  if(array3.length===3){
    return array3;
